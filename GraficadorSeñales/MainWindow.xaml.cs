    ...
    public partial class MainWindow : Window
    {
        ...
        private void btnTransformadaFourier_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (transformada != null)
            {
                ...
                if (frecuenciaFundamental >= 400.00 && frecuenciaFundamental <= 799.99)
                {
                    lblFrecuenciaFundamental_Color.Text = "Rojo";
                }
                if (frecuenciaFundamental >= 800.00 && frecuenciaFundamental <= 1199.99)
                {
                    lblFrecuenciaFundamental_Color.Text = "Verde";
                }
                if (frecuenciaFundamental >= 1200.00 && frecuenciaFundamental <= 1599.99)
                {
                    lblFrecuenciaFundamental_Color.Text = "Morado";
                }
                if (frecuenciaFundamental >= 1600.00 && frecuenciaFundamental <= 1999.99)
                {
                    lblFrecuenciaFundamental_Color.Text = "Azul";
                }
                if (frecuenciaFundamental >= 2000)
                {
                    lblFrecuenciaFundamental_Color.Text = "Amarillo";
                }
